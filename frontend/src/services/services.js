...
export const FetchUser = async () => {
  try {
    ...
    const response = await axiosInstance.get(
      process.env.REACT_APP_BASE_URL + `fetchuser`
    );
...
export const FetchMenuCards = async () => {
  try {
    const response = await axiosInstance.get(
      process.env.REACT_APP_BASE_URL + `fetchMenuCards`
    );
    return response?.data;
  } catch (error) {
    alert(error?.response?.data?.message || error);
...
export const FetchAllMenuCards = async (userId) => {
  try {
    const response = await axios.get(
      process.env.REACT_APP_BASE_URL + `fetchAllMenuCards/${userId}`
    );
    return response?.data;
  } catch (error) {
    alert(error?.response?.data?.message || error);
...
export const AddMenuCard = async (body) => {
  try {
    const response = await axiosInstance.post(
      process.env.REACT_APP_BASE_URL + `addMenuCard`,
      body
    );
    return response?.data;
  } catch (error) {
...
export const DeleteMenuCard = async (id) => {
  try {
    const response = await axiosInstance.delete(
      process.env.REACT_APP_BASE_URL + `deleteMenuCard/${id}`
    );
...
export const UpdateMenuCard = async (body) => {
  try {
    const response = await axiosInstance.put(
      process.env.REACT_APP_BASE_URL + `updateMenuCard`,
      body
    );
